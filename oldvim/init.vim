...
augroup END
map sl :set nosplitright<CR>:set splitright<CR>:vnew <CR>
" map sl :tabedit 
map sv :set nosplitright<CR>:set splitright<CR>:vsplit $MYVIMRC<CR>
map sj :set nosplitbelow<CR>:set splitbelow<CR>:new <CR> 
"  map <up> :res -5<CR>
"  map <down> :res +5<CR>
...
nnoremap  tt :Tagbar<CR>:set relativenumber<CR>
augroup TagBar
    autocmd!
...
nnoremap tg <Cmd>CocCommand explorer<CR>
" nnoremap tg :Fern . -reveal=%<CR>
